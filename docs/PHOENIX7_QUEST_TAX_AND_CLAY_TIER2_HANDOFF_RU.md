...
> Статус на v3M2B.2: ветка C2 «Повстанцы ночью» реализована в
> `codex/v3m2b2-rebels-night` как расширенный маршрут 60–69 с чистым и кровавым
> исходами. Актуальное устройство описано в
> `docs/PHOENIX7_V3M2B2_REBELS_NIGHT_RU.md`. Раздел C2 ниже сохранён как исходный
> проектный замысел; для дальнейшей разработки использовать реализацию и новый документ.
