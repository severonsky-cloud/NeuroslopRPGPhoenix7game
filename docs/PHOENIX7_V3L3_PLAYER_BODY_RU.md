...
- визуальный темп gait-анимации;
- дополнительные особенности силуэта.

В v3L4.1 расовые body-профили больше не меняют фактическую скорость игрока. Числа ниже относятся только к визуальному темпу анимации; gameplay-баланс скорости отложен до отдельного character creation pass.

Доступные базовые профили:

| Профиль | Рост | Темп анимации | Особенности |
|---|---:|---:|---|
| `human` | 100% | 100% | базовый человеческий силуэт |
| `reptiloid` | 98% | 108% | чешуйчатая голова, морда, гребень, когти, хвост |
| `juniorReptiloid` | 88% | 116% | ниже, с более быстрым визуальным шагом и лёгким силуэтом |
...
- оставляет фактическую скорость передвижения общей для всех body-профилей;
- использует расовый коэффициент только для визуального темпа gait-анимации;
