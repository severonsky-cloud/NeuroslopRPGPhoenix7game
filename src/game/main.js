...
const ui = {
  start: $('start'), chargen: $('chargen'), hud: $('hud'), prompt: $('prompt'), toast: $('toast'),
  panel: $('panel'), panelText: $('panelText'), hp: $('hpBar'), st: $('stBar'), ph: $('phBar'),
  hpTxt: $('hpTxt'), stTxt: $('stTxt'), phTxt: $('phTxt'), weapon: $('weapon'), ammo: $('ammo'),
...
function material(color, options = {}) {
  return new THREE.MeshStandardMaterial({
    color, roughness: options.roughness ?? 0.86, metalness: options.metalness ?? 0.02,
