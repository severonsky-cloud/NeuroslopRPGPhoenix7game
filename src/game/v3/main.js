import { PhoenixV3Engine } from './core/engine.js?v=v3p2_weapon_polish_1';
import { installArsenalExtensions } from './core/engineArsenalExtensions.js?v=v3p2_weapon_polish_1';
import { installSettlementExtensions } from './core/engineSettlementExtensions.js?v=30m2a_n1_daynight_integration_1';
import { installArmedWorldExtensions } from './core/engineArmedWorldExtensions.js?v=v3p2_weapon_polish_1';
import { installAIFeelExtensions } from './core/engineAIFeelExtensions.js?v=30m2a_n1_daynight_integration_1';
import { installActorVisualExtensions } from './core/engineActorVisualExtensions.js?v=v3p2_weapon_polish_1';
import { installFortEncounterExtensions } from './core/engineFortEncounterExtensions.js?v=30m2a_n1_daynight_integration_1';
import { installFeelExtensions } from './core/engineFeelExtensions.js?v=v3p2_weapon_polish_1';
...
import { installWw2ArsenalExtensions } from './core/engineWw2ArsenalExtensions.js?v=v3p2_weapon_polish_1';
import { installWw2VehicleExtensions } from './core/engineWw2VehicleExtensions.js?v=v3p2_weapon_polish_1';
import { installWw2VehicleStabilityExtensions } from './core/engineWw2VehicleStabilityExtensions.js?v=v3p2_weapon_polish_1';
import { installBallisticEventExtensions } from './core/engineBallisticEventExtensions.js?v=v3p2_weapon_polish_1';
import { installWeaponWorldExtensions } from './core/engineWeaponWorldExtensions.js?v=v3p2_weapon_polish_1';
import { installWeaponModelPolishExtensions } from './core/engineWeaponModelPolishExtensions.js?v=v3p2_weapon_polish_1';
